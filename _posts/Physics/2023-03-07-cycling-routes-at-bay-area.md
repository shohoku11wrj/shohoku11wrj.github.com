...
* 第一章：常规骑行路线(南湾) [本篇]
<br />
本章给刚入坑或者还没有入坑公路车的朋友普及一下北加湾区我所熟悉的各大基础骑行路线。先从我觉得最经典的5条常规路线开始吧。这5条都是我觉得不需要预先计划，当天早上有空就能带着车去锻炼一下，因为发车点距离南湾东湾这类华人聚集区都挺近的。

* [第二章：湾区四大山骑行路线](/way/cycling-routes-at-bay-area_2)
<br/>
你骑或者不骑，山就在那里。

* [第三章：宝藏骑行路线](/way/cycling-routes-at-bay-area_3)
<br/>
当你有了一定的实力，才是探索的开始。

## 骑行路线App

先简单说下路线规划App，我现在在用的是[Footpath](https://footpathapp.com/)，一款多平台兼容的app。我觉得他最大的优点有三加一个：
* 1.多平台云存储，方便随时分享修改路线。
* 2.画图板一样的路线规划功能：自动矫正路线，可以网页端操作，看出道路的细节，严格遵循路况，比如一段路是不是paved、转角是如何的它都能看的清清楚楚；也可以无视自动矫正精修局部路线。
* 3.提供elevation gain的路线视图，可以直到规划的路线会有多少爬升以及爬升路段分别在哪里。
* 4_extra.导航功能，需要付费订阅，配合手机支架去不熟悉的路线非常好用。
<br/>
...
这是一条相对平直而且周末很(最)popular的路线，适合aero bike，风景也很硅谷，途经几个科技公司园区和Stanford校园，路线的北端一头是在San Mateo水库，在水资源很珍贵的湾区是个风景很独特的地方。
<br/>
